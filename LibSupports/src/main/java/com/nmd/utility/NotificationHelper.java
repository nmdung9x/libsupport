...
public class NotificationHelper extends ContextWrapper {
    ...
    public static String CHANNEL_DEFAULT = "Primary Channel";

    public static String sound = "";
    public static boolean isVibrate = false;
    public static boolean isNotificationLight = false;
    ...
    public NotificationHelper(Context ctx, String channel_id, String channel_name) {
        super(ctx);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            PRIMARY_CHANNEL = channel_id;
            CHANNEL_DEFAULT = channel_name;
            NotificationChannel channel = new NotificationChannel(channel_id, channel_name, NotificationManager.IMPORTANCE_HIGH); //IMPORTANCE_HIGH
            channel.enableVibration(isVibrate);
            if (isNotificationLight) {
                channel.enableLights(isNotificationLight);
            }
    ...
    Notification.Builder getNotificationO(String title, String body, String full_body, Object smallIcon, PendingIntent intent) {
        Notification.Builder mBuilder = new Notification.Builder(this, PRIMARY_CHANNEL);
    ...
    public Notification.Builder getSummaryNotification(String title, String body, int smallIcon, @NonNull String group_key) {
...
//        mBuilder.setLargeIcon(BitmapFactory.decodeResource(getResources(), (Build.VERSION.SDK_INT >= 24 ? R.mipmap.icon_app : R.mipmap.icon_app)));
        return mBuilder;
    }
